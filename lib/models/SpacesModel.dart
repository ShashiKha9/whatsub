...
class Track {
  ...
  Track({required this.title, required this.id, required this.cover, required this.status, required this.disabledMsg, required this.trackRegistrationsAggregate});
  ...
  Track.fromJson(Map<String, dynamic> json) {
    ...
    trackRegistrationsAggregate = (json['track_registrations_aggregate'] != null
        ? new TrackRegistrationsAggregate.fromJson(json['track_registrations_aggregate'])
        : null)!;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.trackRegistrationsAggregate != null) {
      data['track_registrations_aggregate'] = this.trackRegistrationsAggregate.toJson();
    }
    return data;
  }
}
...
class TrackRegistrationsAggregate {
  ...
  TrackRegistrationsAggregate.fromJson(Map<String, dynamic> json) {
    aggregate = (json['aggregate'] != null ? new Aggregate.fromJson(json['aggregate']) : null)!;
  }
