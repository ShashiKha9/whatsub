...
showCustomErrorDialog(BuildContext context, String title, String content) {
  ...
  AlertDialog alert = AlertDialog(
    ...
    title: Text(title ?? "Technical issues", style: TextStyle(fontWeight: FontWeight.w600, color: Colors.white)),
    content: Text(content ?? "Please try again.", style: TextStyle(fontWeight: FontWeight.w500, color: Colors.white)),
    actions: [
