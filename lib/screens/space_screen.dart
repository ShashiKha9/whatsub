...
import 'package:whatsub/screens/chat_layout.dart';
import 'package:whatsub/screens/home_layout.dart';
import 'package:whatsub/screens/in_person_chat_screen.dart';
import 'package:whatsub/screens/social_layout.dart';
    ...
    return SafeArea(
        child: Scaffold(
            ...
            bottomNavigationBar: BottomNavigationBar(
                ...
                items: [
                  BottomNavigationBarItem(icon: Icon(Icons.chat_bubble), title: Text('chat')),
                  BottomNavigationBarItem(icon: Icon(FeatherIcons.home), title: Text('home')),
                  BottomNavigationBarItem(icon: Icon(FontAwesomeIcons.globeEurope), title: Text('social')),
                ]),
